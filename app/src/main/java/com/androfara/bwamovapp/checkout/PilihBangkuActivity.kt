...
class PilihBangkuActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        a3.setOnClickListener {
            if (statusA3){
                a3.setImageResource(R.drawable.ic_icon_empty)
                statusA3 = false
                total -= 1
                beliTiket(total)
            }else{
                a3.setImageResource(R.drawable.ic_icon_selected)
                statusA3 = true
                total += 1
                beliTiket(total)
        ...
        a4.setOnClickListener {
            if (statusA4){
                a4.setImageResource(R.drawable.ic_icon_empty)
                statusA4 = false
                total -= 1
                beliTiket(total)
            }else{
                a4.setImageResource(R.drawable.ic_icon_selected)
                statusA4 = true
                total += 1
                beliTiket(total)
